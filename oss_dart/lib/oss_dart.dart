...
class OssClient {
  ...
  Future init() async {
    ...
    if (expire == null || _checkExpire(expire!)) {
      ...
      print('this.accessKey: ${this.accessKey}');
      print('this.accessSecret: ${this.accessSecret}');
      print('this.secureToken: ${this.secureToken}');
      print('this.expire: ${this.expire}');
    }
  }
  ...
  // getObjectDio(String fileKey) async {
  //   await init();
  //   this.method = 'GET';
  //   this.fileKey = fileKey;
  //   _signRequest();
  ...
  //   final res = await dio.get('https://$bucketName.$endpoint',
  //       options: Options(
