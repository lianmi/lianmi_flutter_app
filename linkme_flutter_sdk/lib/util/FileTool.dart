...
class FileTool {
  factory FileTool() => _getInstance();
  static FileTool get instance => _getInstance();
  static FileTool? _instance;
  FileTool._internal() {}
  static FileTool _getInstance() {
    if (_instance == null) {
      _instance = new FileTool._internal();
    }
    return _instance!;
  }
  ...
  ///生成文件路径
  static String createFilePath(String path, String ext) {
    if (ext == null) {
      return '';
    }
