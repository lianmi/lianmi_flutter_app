...
public class MethodCallHandlerImpl implements MethodChannel.MethodCallHandler {
    ...
    private void init(MethodCall call, MethodChannel.Result result) {
        ...
        Log.i("init", "instanceId=" + instanceId + ", requestId=" + requestId + ", endpoint=" + endpoint + ", accessKeyId=" + accessKeyId);
        ...
        final OSSCredentialProvider credentialProvider = new OSSFederationCredentialProvider() {
            ...
            //构造token
            return new OSSFederationToken(accessKeyId, // Bucket访问凭证
                    accessKeySecret,  // Bucket访问密钥
                    securityToken, // 安全凭证
                    expiration); //有效时间
            }
        };
