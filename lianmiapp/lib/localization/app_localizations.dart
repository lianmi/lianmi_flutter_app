...
class AppLocalizations {
  ...
  String get applicationTitle {
    return Intl.message('Application Title',
        name: 'applicationTitle',
        desc: 'Title for application',
        locale: localeName);
  }

  String get registerBusinessUser {
    return Intl.message('register Business User',
  ...
  String get passwordLogin {
    return Intl.message('Password Login',
        name: 'passwordLogin', desc: 'Password Login', locale: localeName);
  }
  ...
  String get inputNickHint {
    return Intl.message('Please input nick',
        name: 'inputNickHint', desc: 'Please input nick', locale: localeName);
  }

  String get inputContactPersonHint {
    return Intl.message('Please input contact person',
        name: 'inputContactPersonHint',
        desc: 'Please input contact person',
        locale: localeName);
  }

  String get inputLegalPersonnHint {
    return Intl.message('Please input legal person',
        name: 'inputLegalPersonnHint',
        desc: 'Please input legal person',
        locale: localeName);
  }

  String get inputInviteCodeHint {
    return Intl.message('Please input invite code',
        name: 'inputInviteCodeHint',
        desc: 'Please input invite code',
        locale: localeName);
  }
  ...
  String get register {
    return Intl.message('Register',
        name: 'register', desc: 'Register', locale: localeName);
  }
  ...
  String get openBusinessAccount {
    return Intl.message('Open business account', // 开启商户账号
        name: 'openBusinessAccount',
        desc: 'Open business account',
        locale: localeName);
  }

  String get inputPhoneHint {
    return Intl.message('请输入有效的手机号码', // 请输入有效的手机号
        name: 'inputPhoneHint',
