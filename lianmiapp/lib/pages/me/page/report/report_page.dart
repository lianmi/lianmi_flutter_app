...
class storeCenterState extends State<ReportPage> {
  @override
  void initState() {
    super.initState();
  }
    ...
    return Theme(
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              backgroundColor: Colors.white,
              title: Text('投诉举报', style: TextStyle(color: Color(0xff333333))),
              centerTitle: true,
              actions: [],
              elevation: 0,
            ),
  ...
  void dispose() {
    super.dispose();
    // Provider.of<ReportProvider>(App.context!, listen: false).reset();
  }

  void _submit() {
    Provider.of<ReportProvider>(App.context!, listen: false).submit();
  }
}
