...
class _UserQrPageState extends State<UserQrPage> with QrEvents {
  final GlobalKey _qrKey = GlobalKey();

  Widget build(BuildContext context) {
    return Scaffold(
        appBar: MyCustomAppBar(
          centerTitle: '下载App二维码',
          actions: [
            CustomIconButton(
              width: 40.px,
              height: 40.px,
        ...
        body: SafeArea(
          ...
          child: Column(
            children: [
              _qrWidget(),
              Gaps.vGap16,
              Text('扫一扫下载App', style: TextStyles.font15()),
            ],
          ),
        )));
  }
  ...
  Widget _qrWidget() {
    ...
    // String url = UrlUtil.mapToUrl(QrActionEnum.personInfo,
    //     data: {'user_id': App.currentUsername});
    return RepaintBoundary(
        ...
        child: Container(
            ...
            color: Colors.white,
            child: QrImage(
              data: 'https://www.lianmi.cloud/download.html',
              ...
              embeddedImage: ExactAssetImage('assets/images/36.png'),
            )));
  }
