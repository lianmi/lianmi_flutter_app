...
class ZhaotoubiaoPage extends StatefulWidget {
  ...
  ZhaotoubiaoPage(
      this.productId, this.productPrice, this.businessUsername, this.id);

  @override
  _ZhaotoubiaoPageState createState() => _ZhaotoubiaoPageState();
}

class _ZhaotoubiaoPageState extends State<ZhaotoubiaoPage>
