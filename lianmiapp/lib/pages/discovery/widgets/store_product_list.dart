...
class StoreProductList extends StatelessWidget {
  final List<LotteryProductModel> productList;

  final ValueSetter<LotteryProductModel> onTap;
  ...
  Widget _productListItem(BuildContext context, LotteryProductModel model, {required ValueSetter<LotteryProductModel> onTap}) {
    return InkWell(
      child: Container(
