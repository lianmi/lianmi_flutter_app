...
class QxcProvider extends ChangeNotifier {
  ...
  void updateCount() {
    ...
    _count = QixingcaiCalculateUtils.calculateMultiple(oneCount, twoCount, threeCount, fourCount, fiveCount, sixCount, sevenCount);
    notifyListeners();
  }
  ...
  void showNumKeep() {
    ...
    AppNavigator.push(
      App.context!, 
      QxcPage(businessId!, _lotteryId, isNumKeep:true)
    ).then((value) {
