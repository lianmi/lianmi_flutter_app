...
import '../widget/fc3d/ball_select_widget.dart';
import '../widget/fc3d/bottom_widget.dart';

class Fc3dPage extends StatefulWidget {
  ...
  Fc3dPage(this.businessUsername, this.id, {this.isNumKeep = false});

  @override
  _Fc3dPageState createState() => _Fc3dPageState();
}

class _Fc3dPageState extends State<Fc3dPage> implements LinkMeManagerOrderStatusListerner{
  ...
  void didChangeDependencies() {
    WidgetsBinding.instance!.addPostFrameCallback((tim) {
      ...
      Provider.of<Fc3dProvider>(App.context!, listen: false).businessId = widget.businessUsername;
    });
  ...
  void dispose() {
    ...
    Provider.of<Fc3dProvider>(App.context!, listen: false).clear();
  }
