...
import '../widget/pl5/ball_select_widget.dart';
import '../widget/pl5/bottom_widget.dart';

class Pl5Page extends StatefulWidget {
  ...
  Pl5Page(this.businessUsername, this.id, {this.isNumKeep = false});

  @override
  _Pl5PageState createState() => _Pl5PageState();
}

class _Pl5PageState extends State<Pl5Page> implements LinkMeManagerOrderStatusListerner{
  late LotteryProductModel _productInfo; 
  ...
  void didChangeDependencies() {
    WidgetsBinding.instance!.addPostFrameCallback((tim) {
      ...
      Provider.of<LotteryProvider>(App.context!, listen: false).lotteryId = widget.id;
      Provider.of<Pl5Provider>(App.context!, listen: false).businessId = widget.businessUsername;
    });
  ...
  void dispose() {
    ...
    Provider.of<Pl5Provider>(App.context!, listen: false).clear();
  }
