...
class _QxcPageState extends State<QxcPage> implements LinkMeManagerOrderStatusListerner{
  ...
  void didChangeDependencies() {
    WidgetsBinding.instance!.addPostFrameCallback((tim) {
      ...
      Provider.of<QxcProvider>(App.context!, listen: false).businessId = widget.businessUsername;
    });
