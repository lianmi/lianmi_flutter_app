...
import 'package:lianmiapp/pages/lottery/utils/pailie5_calculate_utils.dart';
import 'package:lianmiapp/pages/lottery/utils/qilecai_calculate_utils.dart';
import 'package:lianmiapp/pages/lottery/utils/qixingcai_calculate_utils.dart';
import 'package:lianmiapp/pages/lottery/utils/ssq_calculate_utils.dart';
import 'package:lianmiapp/pages/lottery/widget/select_num_bottom_widget.dart';
...
class _SelectNumPageState extends State<SelectNumPage> {
  ...
  void _genOrder() {
    ...
    LotteryOrderModel order = LotteryOrderModel();
  ...
  void _showOrderDetail(LotteryOrderModel order) {
