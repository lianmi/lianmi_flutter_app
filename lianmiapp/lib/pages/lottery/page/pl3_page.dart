...
class _Pl3PageState extends State<Pl3Page> implements LinkMeManagerOrderStatusListerner{
  ...
  void didChangeDependencies() {
    WidgetsBinding.instance!.addPostFrameCallback((tim) {
      ...
      Provider.of<Pl3Provider>(App.context!, listen: false).businessId = widget.businessUsername;
    });
