...
class Fc3dFushiListItem extends StatelessWidget {
  ...
  Fc3dFushiListItem(this.list,{this.color, this.ballBorderColor, this.showDelete = true});
  ...
  Widget build(BuildContext context) {
    ...
    count = Fucai3dCalculateUtils.calculateMultiple(model.geBalls!.length, model.shiBalls!.length, model.baiBalls!.length);
