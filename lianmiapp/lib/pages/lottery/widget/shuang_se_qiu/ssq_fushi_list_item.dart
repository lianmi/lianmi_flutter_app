...
class SSQFushiListItem extends StatelessWidget {
  ...
  SSQFushiListItem(this.list,{this.color, this.ballBorderColor, this.showDelete = true});
  ...
  Widget build(BuildContext context) {
    ...
    count = SSQCalculateUtils.calculateMultiple(model.redBalls!.length, model.blueBalls!.length);
