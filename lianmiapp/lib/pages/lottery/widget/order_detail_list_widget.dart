...
import 'package:lianmiapp/pages/lottery/widget/dlt/dlt_danshi_list_item.dart';
import 'package:lianmiapp/pages/lottery/widget/dlt/dlt_dantuo_list_item.dart';
import 'package:lianmiapp/pages/lottery/widget/dlt/dlt_fushi_list_item.dart';
import 'package:lianmiapp/pages/lottery/widget/fc3d/fc3d_danshi_list_widget.dart';
import 'package:lianmiapp/pages/lottery/widget/fc3d/fc3d_fushi_list_widget.dart';
import 'package:lianmiapp/pages/lottery/widget/pl3/pl3_danshi_list_widget.dart';
import 'package:lianmiapp/pages/lottery/widget/pl3/pl3_fushi_list_item.dart';
import 'package:lianmiapp/pages/lottery/widget/pl5/pl5_danshi_list_widget.dart';
import 'package:lianmiapp/pages/lottery/widget/pl5/pl5_fushi_list_widget.dart';
import 'package:lianmiapp/pages/lottery/widget/qlc/qlc_list_item.dart';
import 'package:lianmiapp/pages/lottery/widget/qxc/qxc_danshi_list_widget.dart';
import 'package:lianmiapp/pages/lottery/widget/qxc/qxc_fushi_list_widget.dart';
import 'package:lianmiapp/pages/lottery/widget/shuang_se_qiu/ssq_danshi_list_item.dart';
import 'package:lianmiapp/pages/lottery/widget/shuang_se_qiu/ssq_dantuo_list_item.dart';
import 'package:lianmiapp/pages/lottery/widget/shuang_se_qiu/ssq_fushi_list_item.dart';

class OrderDetailListWidget extends StatelessWidget {
  final List<dynamic> selectedNums;

  OrderDetailListWidget(this.selectedNums);
