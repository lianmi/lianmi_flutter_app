...
class DltFushiListItem extends StatelessWidget {
  ...
  DltFushiListItem(this.list,{this.color, this.ballBorderColor, this.showDelete = true});
  ...
  Widget build(BuildContext context) {
    ...
    count = DLTCalculateUtils.calculateMultiple(model.frontBalls!.length, model.backBalls!.length);
