...
class DltDantuoListItem extends StatelessWidget {
  ...
  DltDantuoListItem(this.list, {this.color, this.ballBorderColor, this.showDelete = true});
  ...
  Widget build(BuildContext context) {
    ...
    count = DLTCalculateUtils.calculateDantuo(model.danBalls!.length, model.frontBalls!.length, model.backBalls!.length);
    ...
    return Slidable(
      ...
      secondaryActions: showDelete!?<Widget>[
        IconSlideAction(
          ...
          onTap: (){
            Provider.of<DltProvider>(context, listen: false).deleteLotterys(list);
          }
        ),
      ]:[]
    );
