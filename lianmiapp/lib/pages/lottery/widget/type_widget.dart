...
class TypeWidget extends StatefulWidget {
  ...
  TypeWidget({required this.titles, this.defaultIndex = 0, required this.onChangeIndex, this.showTopLine = false, this.showUnderLine = false});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        border: Border(
          top: BorderSide(width: 1.px, color: widget.showTopLine?Colours.line:Colors.transparent),
          bottom: BorderSide(width: 1.px, color: widget.showUnderLine?Colours.line:Colors.transparent)
        )
      ),
