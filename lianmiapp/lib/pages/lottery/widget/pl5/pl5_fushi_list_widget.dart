...
class Pl5FushiListItem extends StatelessWidget {
  ...
  Pl5FushiListItem(this.list,{this.color, this.ballBorderColor, this.showDelete = true});
  ...
  Widget build(BuildContext context) {
    ...
    count = PaiLie5CalculateUtils.calculateMultiple(model.geBalls!.length, model.shiBalls!.length, model.baiBalls!.length, model.qianBalls!.length, model.wanBalls!.length);
